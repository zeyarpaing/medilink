...
export const CheckRadioItem = ({ className, outline, ...props }: CheckboxProps & { outline?: boolean }) => {
  const { children, ...otherProps } = props;
  ...
  return (
    <CheckBox
      classNames={{
        base: twMerge(
          'flex flex-1 m-0 bg-content1 hover:bg-content2 items-center w-full',
          'flex-row max-w-full cursor-pointer rounded-lg gap-2 p-3 border-2',
